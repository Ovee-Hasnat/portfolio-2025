...
export default function MeetDev() {
  ...
  return (
    <section className="relative text-zinc-800 max-w-screen-2xl mx-auto pt-12 pb-20 lg:pt-52 lg:pb-52 px-6 flex gap-24 md:gap-40 md:items-end justify-between flex-col lg:flex-row-reverse">
